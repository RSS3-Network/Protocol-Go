...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.5 --type=UnknownType --transform=snake --trimprefix=Type --output=unknown.yaml -t schema.yaml.tmpl
