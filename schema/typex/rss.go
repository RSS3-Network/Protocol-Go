...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.5 --type=RSSType --transform=snake --trimprefix=RSS --output=../../openapi/type/RSS.yaml -t ../../openapi/tmpl/Type.yaml.tmpl
type RSSType uint64
