...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.5 --type=CollectibleType --transform=snake --trimprefix=Collectible --output=collectible.yaml -t schema.yaml.tmpl
