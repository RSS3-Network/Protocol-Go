...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.5 --type=SocialType --transform=snake --trimprefix=Social --output=social.yaml -t schema.yaml.tmpl
