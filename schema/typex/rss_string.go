// Code generated by "enumer --values --type=RSSType --transform=snake --trimprefix=RSS --output rss_string.go --json --sql"; DO NOT EDIT.
...
var _RSSTypeValues = []RSSType{RSSFeed}

var _RSSTypeNameToValueMap = map[string]RSSType{
	_RSSTypeName[0:4]:      RSSFeed,
	_RSSTypeLowerName[0:4]: RSSFeed,
}
