...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.5 --type=MetaverseType --transform=snake --trimprefix=Metaverse --output=../../openapi/type/Metaverse.yaml -t ../../openapi/tmpl/Type.yaml.tmpl
