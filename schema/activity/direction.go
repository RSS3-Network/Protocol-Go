...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.5 --type=Direction --transform=snake --trimprefix=Direction --output=direction.yaml -t schema.yaml.tmpl
