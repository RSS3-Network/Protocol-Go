...
//go:generate go run --mod=mod github.com/rss3-network/enum-schema@v0.1.3 --type=EthereumChainID --linecomment --indent --example=base --output=ethereum_chain_schema.json --x-go-type=network.EthereumChainID --x-go-type-import-path=github.com/rss3-network/protocol-go/schema/network
